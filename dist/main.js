...
*/
  ...
  \***************************/
      /***/ (
        ...
        /* harmony import */ var _user__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ./user */ "./src/user.js");
        ...
        /* harmony import */ var _view__WEBPACK_IMPORTED_MODULE_4__ =
          __webpack_require__(/*! ./view */ "./src/view.js");

        const controller = (() => {
          let currentProjectId =
            _user__WEBPACK_IMPORTED_MODULE_0__["default"].getProjectIdCounter();
          ...
          const initializeUser = () => {
            ...
            const todoDesc =
              "This is a todo. Add checklist tasks, due dates, and priorities here.";
            const dueDate = "Tues, 10: 30 am";
            const priority = "Urgent";
            const notes = "Add notes and any additional thoughts here";
            const firstTodo = (0,
            _todo__WEBPACK_IMPORTED_MODULE_2__["default"])(
              todoId,
              todoTitle,
              todoDesc,
              dueDate,
            ...
            const firstTask = (0,
            _task__WEBPACK_IMPORTED_MODULE_3__["default"])(
              taskName,
              firstTodo.getTaskIdCounter()
            );
            firstTodo.addTask(firstTask);
            firstTodo.incrementTaskIdCounter();
            firstProject.initialAddTodo(firstTodo);
            _user__WEBPACK_IMPORTED_MODULE_0__["default"].addProject(
              firstProject
            );
          };
            ...
            _user__WEBPACK_IMPORTED_MODULE_0__["default"]
              ...
              .forEach((project) => {
                _view__WEBPACK_IMPORTED_MODULE_4__[
                  "default"
                ].setProjectListItem(project.getName(), project.getId());
              });
          };

          const initializeProjectView = () => {
            if (
              _user__WEBPACK_IMPORTED_MODULE_0__["default"].getProjects()
                .length !== 0
            ) {
              const project =
                _user__WEBPACK_IMPORTED_MODULE_0__["default"].getProjects()[0];
              _view__WEBPACK_IMPORTED_MODULE_4__["default"].setCurrentProjectId(
                project.getId()
              );
              _view__WEBPACK_IMPORTED_MODULE_4__["default"].setProjectTitle(
                project.getName()
              );
              _view__WEBPACK_IMPORTED_MODULE_4__[
                "default"
          ...
          const loadProject = (id) => {
            ...
            const projects =
              _user__WEBPACK_IMPORTED_MODULE_0__["default"].getProjects();
            const projectTarget = projects.find(
            ...
            _view__WEBPACK_IMPORTED_MODULE_4__["default"].setProjectDescription(
          ...
          const addTodos = (project) => {
            ...
            list.forEach((todo) => {
              ...
              _view__WEBPACK_IMPORTED_MODULE_4__["default"].addTodoCard(
                todoObj
              );
            });
          };
          ...
          const addSubmitProjectEvent = () => {
            _view__WEBPACK_IMPORTED_MODULE_4__["default"].bindSubmitProject(
              handleSubmitProject
            );
          };

          const addSubmitTodoEvent = () => {
            _view__WEBPACK_IMPORTED_MODULE_4__["default"].bindSubmitTodo(
              handleSubmitTodo
            );
          };
          ...
          const onTaskListChanged = () => {
            const currentProject =
              _user__WEBPACK_IMPORTED_MODULE_0__["default"].getProjectById(
                currentProjectId
              );
          ...
          const handleSubmitTask = (projectId, todoId, taskName) => {
            ...
            const newTask = (0, _task__WEBPACK_IMPORTED_MODULE_3__["default"])(
              taskName,
              todoTarget.getTaskIdCounter()
            );
          ...
          const handleSubmitTodo = (todo) => {
            const currentProject = _user__WEBPACK_IMPORTED_MODULE_0__[
              "default"
            ].getProjectById(todo.projectId);
          ...
          const handleDeleteProject = (projectId) => {
            ...
            _user__WEBPACK_IMPORTED_MODULE_0__["default"].removeProject(
              project
            );
          };
          ...
          initializeUser();
          _view__WEBPACK_IMPORTED_MODULE_4__["default"].bindAddTask(
            handleSubmitTask
          );
          _view__WEBPACK_IMPORTED_MODULE_4__["default"].bindAddTodo(
            addSubmitTodoEvent
          );
          _view__WEBPACK_IMPORTED_MODULE_4__["default"].bindAddProject(
            addSubmitProjectEvent
          );
          _user__WEBPACK_IMPORTED_MODULE_0__["default"].bindProjectListChanged(
            onProjectListChange
          );
          _view__WEBPACK_IMPORTED_MODULE_4__["default"].bindChangeProject(
            onProjectSwitch
          );
          _view__WEBPACK_IMPORTED_MODULE_4__["default"].bindToggleTask(
            handleTaskToggle
          );
          _view__WEBPACK_IMPORTED_MODULE_4__["default"].bindDeleteProject(
            handleDeleteProject
          );
          _view__WEBPACK_IMPORTED_MODULE_4__["default"].bindDeleteTask(
            handleDeleteTask
          );
          _view__WEBPACK_IMPORTED_MODULE_4__["default"].bindDeleteTodo(
            handleDeleteTodo
          );
          _view__WEBPACK_IMPORTED_MODULE_4__["default"].bindMinimizeTodo(
            handleMinimizeTodo
          );
  ...
  \*********************/
      /***/ (
        ...
        /* harmony import */ var _view_helpers__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ./view-helpers */ "./src/view-helpers.js");
        ...
        const view = (() => {
          ...
          const resetProjectView = () => {
            ...
            projectContainer.appendChild(
              _view_helpers__WEBPACK_IMPORTED_MODULE_0__["default"].createIdDiv(
                "todo-list"
              )
            );
          ...
          const setProjectListItem = (project, projectId) => {
            const projectListContainer =
              _view_helpers__WEBPACK_IMPORTED_MODULE_0__["default"].createDiv(
                "project-list-container"
              );
            const projectListItem = _view_helpers__WEBPACK_IMPORTED_MODULE_0__[
              "default"
            ].createListItem(projectListContainer, project);
            projectListItem.setAttribute("project-id", projectId);
            const deleteProjectIcon =
              _view_helpers__WEBPACK_IMPORTED_MODULE_0__["default"].createIcon(
          ...
          const setProjectTitle = (title) => {
            _view_helpers__WEBPACK_IMPORTED_MODULE_0__["default"].createText(
              projectContainer,
              "before",
              "h2",
              title,
          ...
          const setTodoTitle = (todoId, title, todoCard, cardSection) => {
            ...
            const ellipsis = _view_helpers__WEBPACK_IMPORTED_MODULE_0__[
              "default"
            ].createIcon(
              titleContainer,
              "fa-solid",
          ...
          function createFloatingSelection(todoId, container, cardSection) {
            ...
            const optionsList = _view_helpers__WEBPACK_IMPORTED_MODULE_0__[
              "default"
            ].createList(selectionContainer, "options-list");
            const minimizeCardOption =
              _view_helpers__WEBPACK_IMPORTED_MODULE_0__[
                "default"
              ].createListItem(optionsList, "Minimize Todo");
            const deleteTodoOption = _view_helpers__WEBPACK_IMPORTED_MODULE_0__[
              "default"
            ].createListItem(optionsList, "Delete Todo");
          ...
          const setTodoStatus = (dueDate, priority, todoCard) => {
            const status = _view_helpers__WEBPACK_IMPORTED_MODULE_0__[
              "default"
            ].createDiv("mb-16", "status-container");
            _view_helpers__WEBPACK_IMPORTED_MODULE_0__["default"].createText(
              status,
              "after",
              "p",
            ...
            const priorityLabel = _view_helpers__WEBPACK_IMPORTED_MODULE_0__[
              "default"
          ...
          const setTask = (task, container) => {
            const taskName = _view_helpers__WEBPACK_IMPORTED_MODULE_0__[
              "default"
            ].createText(container, "after", "p", task);
            return taskName;
          };

          const setTaskCheckCircle = (
            todoId,
            container,
            taskElement,
            taskObj
          ...
          const setAddTaskButton = (projectId, todoId, todoCard) => {
            const addTaskButton = _view_helpers__WEBPACK_IMPORTED_MODULE_0__[
              "default"
            ].createButtonForm(
              "div",
              "none",
            ...
            const taskForm = _view_helpers__WEBPACK_IMPORTED_MODULE_0__[
              "default"
            ].createInputForm(
              "none",
              "Enter task name",
            ...
            const taskSubmitButton = _view_helpers__WEBPACK_IMPORTED_MODULE_0__[
              "default"
            ].createButtonForm(
              "button",
              "none",
          ...
          const setTodoForm = (container) => {
            ...
            _view_helpers__WEBPACK_IMPORTED_MODULE_0__[
              "default"
            ].createFormLabel("datetime-label", "Due Date", form);
            _view_helpers__WEBPACK_IMPORTED_MODULE_0__[
              "default"
            ].createDateTimeInput("due-date-input", form);
            const todoTitle = _view_helpers__WEBPACK_IMPORTED_MODULE_0__[
              "default"
            ].createInputForm("todo-title", "Title", form);
            ...
            const todoDescription = _view_helpers__WEBPACK_IMPORTED_MODULE_0__[
              "default"
            ].createTextAreaForm("description-textarea", "Description", form);
            const todoNotes = _view_helpers__WEBPACK_IMPORTED_MODULE_0__[
              "default"
            ].createTextAreaForm("notes-input", "Notes", form);
            _view_helpers__WEBPACK_IMPORTED_MODULE_0__[
              "default"
            ].createButtonForm("button", "todo-submit-btn", "SUBMIT", form);
          ...
          const setAddTodoButton = () => {
            ...
            const addTodoButton = _view_helpers__WEBPACK_IMPORTED_MODULE_0__[
              "default"
            ].createButtonForm(
              "div",
              "add-todo-button",
          ...
          const toggleProjectForm = () => {
            ...
            if (projectFormContainer) {
              ...
              const formContainer = _view_helpers__WEBPACK_IMPORTED_MODULE_0__[
                "default"
              ].createIdDiv("project-form-container");
              const nameForm = _view_helpers__WEBPACK_IMPORTED_MODULE_0__[
                "default"
              ].createInputForm(
                "project-name-form",
              ...
              const formSubmit = _view_helpers__WEBPACK_IMPORTED_MODULE_0__[
                "default"
              ].createButtonForm(
                "button",
          ...
          const resetTodoSubmitForm = () => {
            ...
            document.querySelector("#todo-form-container").style.display =
              "none";
          };

          const resetProjectSubmitForm = () => {
            const projectNameForm =
              document.querySelector("#project-name-form");
  ...
  \**********************/
    ...
    /* harmony import */ var _controller__WEBPACK_IMPORTED_MODULE_1__ =
      __webpack_require__(/*! ./controller */ "./src/controller.js");
